...
describe("StatutBadge", () => {
  it("affiche le nom du statut", () => {
    render(
      <StatutBadge statut={{ nom_statut: "Confirmée", couleur: "success" }} />,
    );
  ...
  it("applique la couleur verte pour un statut success", () => {
    ...
    expect(screen.getByText("Confirmée")).toHaveClass(
      "bg-green-100",
      "text-green-800",
    );
  });
  ...
  it("applique la couleur rouge pour un statut danger", () => {
    render(
      <StatutBadge statut={{ nom_statut: "Annulée", couleur: "danger" }} />,
    );
    expect(screen.getByText("Annulée")).toHaveClass(
      "bg-red-100",
      "text-red-800",
    );
  });
  ...
  it("retombe sur le gris pour une couleur inconnue", () => {
    render(
      <StatutBadge statut={{ nom_statut: "Inconnu", couleur: "violet" }} />,
    );
