    ...
    <div className="hotel-offers">
      ...
      <div className="space-y-4">
        {chambres.map((chambre) => {
          ...
          // Le champ en base est `prix_nuit` (pas `prix_actuel`)
          const meilleureOffre = chambre.offres?.[0];
          const prixMinimum = meilleureOffre?.prix_nuit;
          ...
          return (
            ...
            >
              <div className="grid grid-cols-1 md:grid-cols-12">
                {/* Image chambre (4/12) */}
                <div className="relative md:col-span-4 h-48 md:h-full">
                  <Image
                    src={
                      chambre.images?.[0]?.url_img || "/images/default-room.jpg"
                    }
